      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          ...
          <span class="text-danger"
                v-if="errors.has('firstName')"><br/><span>{{errors.first('firstName')}}</span></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input v-model="lastName"
                 ...
                 focus="3"/>
          <span class="text-danger" v-if="errors.has('lastName')"><br/><span>{{errors.first('lastName')}}</span></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input v-model="newPassword"
                 ...
                 focus="4"/>
          <span class="text-danger"
                v-if="errors.has('newPassword')"><br/><span>{{errors.first('newPassword')}}</span></span>
        </div>
      </div>
      <div class="form-group">
        <!--Text field-->
        ...
        <div class="col-md-4">
          <input v-model="confirmPassword"
                 ...
                 focus="5"/>
          <span class="text-danger"
                v-if="errors.has('confirmPassword')"><br/><span>{{errors.first('confirmPassword')}}</span></span>
        </div>
      </div>
      <button @click="register()" type="submit" class="btn btn-primary btn-lg"
              :disabled="email && newPassword && confirmPassword && errors.any()">Register
      </button>
    </form>
